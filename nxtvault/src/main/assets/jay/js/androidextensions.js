...
var AndroidExtensions = {
    ...
    //latest version: https://github.com/jonesnxt/jay-client/commit/01446df387904e609b64a72fbe7e1cb15f7d9d4a
    extractBytesData: function(trfBytes, senderPubKey)
    {
		...
		else if(type == 1)
		{
			...
			else if(subtype == 6)
			{
				...
				var alias = converters.byteArrayToString(rest.slice(2, rest[1]+2));
				var target = "";
				if (recipient == "NXT-MRCC-2YLS-8M54-3CMAJ") { this.setReview(3, "Buyer", "Anyone"); target = "anyone"; }
				else { this.setReview(3, "Buyer", recipient); target = recipient; }
		...
		else if(type == 2)
		{
			if(subtype == 0)
			{
				...
				this.setReview(5, "Decimals", decimals);
				this.setReview(6, "Fee", fee/100000000 + " nxt");
			}
			else if(subtype == 1)
			{
		...
		else if(type == 3)
		{
			...
			else if(subtype == 2)
			{
				...
				this.setReview(4, "New Price", newprice/100000000 + " nxt");
				this.setReview(5, "Fee", fee/100000000 + " nxt");
